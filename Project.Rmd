---
title: "Project:  Prediction Assignment Writeup"
author: "Ali Attajer"
date: "16/06/2020"
...
For reproduceability, An overall pseudo-random number generator seed was set at 1234 for all code:
...
The following 3 transformations were used to return tidy data:  
...
**Transformation 3:** Cleaning Variables with too many NAs. For Variables that have more than a 60% threshold of NA’s we're going to leave them out:
...
#And to make sure Corection really worked, simple smart technique:
